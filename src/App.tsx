...
import { LumozzkEVMTestnet } from '@particle-network/chains';
...
const particle = new ParticleNetwork({
  ...config,
  chainName: LumozzkEVMTestnet.name,
  chainId: LumozzkEVMTestnet.id,
...
const smartAccount = new SmartAccount(new ParticleProvider(particle.auth), {
  ...config,
  aaOptions: {
    simple: [{ chainId: LumozzkEVMTestnet.id, version: '1.0.0' }]
  }
});
